...
| Trigger    | Output                                                                                                                                    |
| ---------- | ----------------------------------------------------------------------------------------------------------------------------------------- |
| `:myemail` | `anthony@coffey.codes`                                                                                                                    |
| `:email`   | `coffey.j.anthony@gmail.com`                                                                                                              |
| `:myphone` | `737-932-4565`                                                                                                                            |
| `:sig`     | Best,<br>Anthony Coffey<br>737.932.4565<br>anthony@coffey.codes<br>linktr.ee/coffeycodes<br>schedule time with me: https://bit.ly/44j8x5v |
| `:website` | `https://coffey.codes`                                                                                                                    |
| `:domain`  | `coffey.codes`                                                                                                                            |
